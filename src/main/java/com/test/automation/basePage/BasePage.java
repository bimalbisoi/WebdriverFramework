...
public class BasePage {
	...
	{
		/*
		 * String browserName= Config.getConfigProperty("BROWSER_NAME"); => Here we read
		 * the browser name from properties file Here we are passing it from command
		 * prompt(using "mvn test -Dbrowser=chrome" ) instead of read the browser name
		...
		// Creating the object of WebEventListener class (which defined under Utils
		// package) to register it with EventFiringWebdriver
